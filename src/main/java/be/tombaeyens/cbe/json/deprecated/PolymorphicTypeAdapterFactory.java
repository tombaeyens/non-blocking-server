...
import be.tombaeyens.cbe.json.deprecated.DataTypeAdapter.Adapter;
import be.tombaeyens.cbe.json.deprecated.DataTypeAdapter.BoundField;
import be.tombaeyens.cbe.json.deprecated.DataTypeAdapter.TypeAdapterRuntimeTypeWrapper;
...
public class PolymorphicTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public PolymorphicTypeAdapterFactory(ConstructorConstructor constructorConstructor,
